...
Project ini pake lisensi yang sama dengan [privasistent](https://github.com/Glenferdinza/privasistent.git). Check file LICENSE di repo tersebut untuk detail lengkap.
